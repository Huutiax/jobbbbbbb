<template>
  <div class="app-search-column">
    ...
    <el-input
      ...
      "
      @input="handleChange"
      @keypress.native.enter="enterChange"
    />
    ...
    <!-- 数字范围选择器 -->
    <AppNumberRange
      v-if="column.component && column.component.name === 'numberRange'"
      v-model="modelVal"
      v-bind="Object.assign({}, column.component)"
      @change="handleChange"
    />
    ...
    <!-- 选择器 多选-->
    <el-select
      v-if="column.component && column.component.name === 'multiple-select'"
      v-model="modelVal"
      multiple
      v-bind="
        Object.assign(
    ...
    <AppDatePicker
      v-if="
        column.component &&
          (column.component.name === 'date-range' ||
            column.component.name === 'range')
      "
      v-model="modelVal"
      :options="
        Object.assign(
...
import AppNumberRange from "@/components/AppNumberRange";
